...
//            }
//
//            int show1 = *(int *) node_to_send->packet;
//            int show_len1 = *(int *) (node_to_send->packet + sizeof(int));
//            bool show_last1 = *(bool *) (node_to_send->packet + 2*sizeof(int));
//            char *show_content1 = node_to_send->packet + PACKET_HEADER_LEN;
//            cout << "SEQ NUM: " << curr_seq << " SEND SEQUENCE NUM:" << show1 << " LEN: "<< show_len1 << " LAST: " << show_last1;
//            cout << " CONTENT: "<< show_content1 << endl;
//            // Send data packet
//            memcpy(buff, node_to_send->packet, BUFFER_SIZE);
//            int show2 = *(int *) buff;
//            int show_len2 = *(int *) (buff + sizeof(int));
//            bool show_last2 = *(bool *) (buff + 2*sizeof(int));
//            char *show_content2 = buff + PACKET_HEADER_LEN;
//            cout << "SEQ NUM2: " << curr_seq << " SEND SEQUENCE NUM2:" << show2 << " LEN2: "<< show_len2 << " LAST2: " << show_last2;
//            cout << " CONTENT2: "<< show_content2 << endl;
